  ...
  runtimeEnv:
    {
      ...
      NEXT_PUBLIC_APPWRITE_MEMBERS_ID: process.env.NEXT_PUBLIC_APPWRITE_MEMBERS_ID,
      NEXT_PUBLIC_APPWRITE_PROJECTS_ID: process.env.NEXT_PUBLIC_APPWRITE_PROJECTS_ID,
